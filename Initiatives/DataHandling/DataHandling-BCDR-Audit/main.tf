...
locals {
  ...
  policy_initiative       = "DataHandling-BCDR-Audit" # ToDo Enter Initiative Name
}

# To retrieve management group data for policy-definition module and management-group-policy-assignment module
data "azurerm_management_group" "mg" {
  name = "<<Management-Group-Id>>" # ToDo Management Group ID
}
...
data "azurerm_policy_set_definition" "DataHandling-BCDR-Audit" {
