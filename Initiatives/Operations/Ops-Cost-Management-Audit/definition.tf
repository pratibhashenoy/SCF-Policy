...
module "create_initiative_Ops_Cost_Management_Audit" {
  source                  = "../../../modules/policies/policy-set-definition"
  initiative_name         = "Ops-Cost-Management-Audit"
  initiative_display_name = "Ops-Cost-Management-Audit"
  initiative_description  = "Policies related to Operations Cost Management Audit subcategory"
  initiative_category     = "Ops-Cost-Management-Audit"
  management_group_id     = data.azurerm_management_group.mg.id
  merge_effects    = false
