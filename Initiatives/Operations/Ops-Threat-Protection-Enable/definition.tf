...
############## Create Ops-Threat-Protection-Enable Initiative ############

module "create_initiative_Ops_Threat_Protection_Enable" {
  source                  = "../../../modules/policies/policy-set-definition"
  initiative_name         = "Ops-TP-Enable"
  initiative_display_name = "Ops-TP-Enable"
  initiative_description  = "Policies related to Operations Threat-Protection-Enable subcategory"
  initiative_category     = "Ops-Threat-Protection-Enable"
  management_group_id     = data.azurerm_management_group.mg.id
  merge_effects    = false
