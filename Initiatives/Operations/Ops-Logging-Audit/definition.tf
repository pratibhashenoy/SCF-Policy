...
module "create_initiative_Ops_Logging_Audit" {
  source                  = "../../../modules/policies/policy-set-definition"
  initiative_name         = "Ops-Logging-Audit"
  initiative_display_name = "Ops-Logging-Audit"
  initiative_description  = "Policies related to Operations Logging Audit subcategory"
  initiative_category     = "Ops-Logging-Audit"
  management_group_id     = data.azurerm_management_group.mg.id
  merge_effects    = false
